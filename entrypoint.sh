...
TURBOQUANT_KEY_BITS=${SGLANG_TURBOQUANT_KEY_BITS:-}
TURBOQUANT_VALUE_BITS=${SGLANG_TURBOQUANT_VALUE_BITS:-}
TURBOQUANT_PROTECTED_HEAD=${SGLANG_TURBOQUANT_PROTECTED_LAYERS_HEAD:-}
TURBOQUANT_PROTECTED_TAIL=${SGLANG_TURBOQUANT_PROTECTED_LAYERS_TAIL:-}
...
exec sglang serve \
    ...
    ${TURBOQUANT_KEY_BITS:+--turboquant-key-bits "$TURBOQUANT_KEY_BITS"} \
    ${TURBOQUANT_VALUE_BITS:+--turboquant-value-bits "$TURBOQUANT_VALUE_BITS"} \
    ${TURBOQUANT_PROTECTED_HEAD:+--turboquant-protected-layers-head "$TURBOQUANT_PROTECTED_HEAD"} \
    ${TURBOQUANT_PROTECTED_TAIL:+--turboquant-protected-layers-tail "$TURBOQUANT_PROTECTED_TAIL"} \
